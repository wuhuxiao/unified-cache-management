...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model", default=os.environ.get("SERVED_MODEL_NAME", "DeepSeek-V4-Flash")
    )
    parser.add_argument(
        "--tokenizer-path",
        default=os.environ.get("MODEL_PATH", "/home/models/DeepSeek-V4-Flash"),
    )
    ...
    parser.add_argument(
        "--results-dir", default=str(REPO_ROOT / "results" / "llmperf_vllm_ucm")
    )
