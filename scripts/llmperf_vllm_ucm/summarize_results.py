...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize baseline/HBM/UCM llmperf results.")
...
def main() -> int:
    ...
    payloads = {name: load_payload(results_dir, name) for name in ["baseline", "hbm", "ucm"]}
    ...
    for scenario in ["baseline", "hbm", "ucm"]:
        ...
        e2e_imp = improve_latency(baseline_metrics.get("end_to_end_latency_s_mean"), e2e)
